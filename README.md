...
🎯 **Backend Developer @Evatril**  
Full Stack JavaScript Developer passionate about building real-world, scalable web applications.  
Currently exploring **Nest.js**, **BullMQ**, and deeper **SQL + NoSQL** architecture design.

---

### 🚀 Current Focus
- 🔭 Currently working on production-level MERN stack apps with authentication, payments & real-time features
- 💡 Sharpening frontend skills through UI cloning and responsive design challenges
- 🧠 Learning to design scalable APIs and integrating SQL + NoSQL databases effectively
...
![BullMQ](https://img.shields.io/badge/-BullMQ-E02020?logo=redis&logoColor=white&style=flat)
...
![shadcn/ui](https://img.shields.io/badge/-shadcn%2Fui-111827?logo=shadcnui&logoColor=white&style=flat)
